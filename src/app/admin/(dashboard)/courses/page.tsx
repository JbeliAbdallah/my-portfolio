...
export default async function CoursesPage({
  ...
  return (
    <div>
      ...
      {created === "true" && <Message>Course created successfully.</Message>}

      {updated === "true" && <Message>Course updated successfully.</Message>}

      {deleted === "true" && <Message>Course deleted successfully.</Message>}
          ...
          courses.map((course) => (
            ...
            >
              <div>
                ...
                <p className="mt-1 text-sm text-zinc-400">/{course.slug}</p>
